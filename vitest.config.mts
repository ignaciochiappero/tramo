...
export default defineConfig({
  ...
  test: {
    ...
    hookTimeout: 30_000,
    // Each database test file boots its own PGlite. With one worker per core,
    // a many-core machine boots a dozen at once, they starve each other, and
    // hooks time out on a fresh clone. Four workers pass every time, faster.
    maxWorkers: 4,
  },
});
