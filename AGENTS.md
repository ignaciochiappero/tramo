...
**Not running yet?** Follow [docs/setup.md](docs/setup.md) step by step before touching code. It marks the steps that need a person (accounts, secrets) and how to check each one.
...
3. The design system was ported from Fragua, a private sibling project. You don't need it: its rules live in this file and in `app/globals.css`.
